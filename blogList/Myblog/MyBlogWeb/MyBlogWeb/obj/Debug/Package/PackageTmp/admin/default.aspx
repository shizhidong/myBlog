...
<head runat="server">
    ...
    <style type="text/css">
    .tabRiJi{width:750px; height:auto; overflow:hidden; margin-bottom:20px}
    .tabRiJi tr th,.tabRiJi tr td{ border:1px solid #333; padding:10px 0px; text-align:center; line-height:24px; padding:5px}
    </style>
</head>
<body>
    <div style="width: 1030px; height: auto; overflow: hidden; margin: 0 auto">
        ...
        <div style="width: 800px; height: auto; border: 1px solid #212121; padding-top: 10px;
            ...
            <div style="border-bottom: 4px solid #000; overflow: hidden; padding-bottom: 30px;
                ...
                <br />
                <div style="margin-left: 200px;">
                    <asp:Button ID="btnAdd" runat="server" Text="添加" OnClick="btnAdd_Click" /></div>
            </div>
            <div style="border-bottom: 4px solid #000; overflow: hidden; padding-bottom: 30px;
                margin-top: 20px">
                <h4 id="3F">
                ...
                <br />
                <div style="margin-left: 200px;">
                    <asp:Button ID="Button1" runat="server" Text="添加" OnClick="btnAdd_ClickTuiJian" /></div>
            </div>
            <!--个人日记-->
            <div style="border-bottom: 4px solid #000; overflow: hidden; padding-bottom: 30px;
                margin-top: 20px">
